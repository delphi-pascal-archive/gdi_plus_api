...
uses
  Windows, Graphics, ActiveX, DirectDraw;
...
type
  ...
  pGPSizeFDynArray = ^TGPSizeFDynArray;
  TGPSizeFDynArray = array of TGPSizeF;

function GPSizeFMake(const W, H : Single) : TGPSizeF;
function GPSizeFAdd(const SzA, SzB : TGPSizeF) : TGPSizeF;
function GPSizeFSub(const SzA, SzB : TGPSizeF) : TGPSizeF;
function GPSizeFEqual(const SzA, SzB : TGPSizeF) : Boolean;
function GPSizeFEmpty(const Sz : TGPSizeF) : Boolean;

{<not GDI+ standard!>}
function GPSizeFGetMiddle(const Sz : TGPSizeF) : TGPSizeF;
...
type
  ...
  pGPSizeDynArray = ^TGPSizeDynArray;
  TGPSizeDynArray = array of TGPSize;

function GPSizeMake(const W, H : integer) : TGPSize;
function GPSizeAdd(const SzA, SzB : TGPSize) : TGPSize;
function GPSizeSub(const SzA, SzB : TGPSize) : TGPSize;
function GPSizeEqual(const SzA, SzB : TGPSize) : Boolean;
function GPSizeEmpty(const Sz : TGPSize) : Boolean;

{<not GDI+ standard!>}
function GPSizeGetMiddle(const Sz : TGPSize) : TGPSize;
...
type
  ...
  pGPPointFDynArray = ^TGPPointFDynArray;
  TGPPointFDynArray = array of TGPPointF;

function GPPointFMake(const X, Y : Single) : TGPPointF;
function GPPointFAdd(const PtA, PtB : TGPPointF) : TGPPointF;
function GPPointFSub(const PtA, PtB : TGPPointF) : TGPPointF;
function GPPointFEqual(const PtA, PtB : TGPPointF) : Boolean;
...
type
  ...
  pGPPointDynArray = ^TGPPointDynArray;
  TGPPointDynArray = array of TGPPoint;

function GPPointMake(const X, Y : integer) : TGPPoint;
function GPPointAdd(const PtA, PtB : TGPPoint) : TGPPoint;
function GPPointSub(const PtA, PtB : TGPPoint) : TGPPoint;
function GPPointEqual(const PtA, PtB : TGPPoint) : Boolean;
...
type
  ...
  TGPRectF = record
    case integer of
      ...
      1 : ( Location : TGPPointF; Size  : TGPSizeF; );
  end;
  pGPRectFDynArray = ^TGPRectFDynArray;
  TGPRectFDynArray = array of TGPRectF;

function GPRectFMake(const X, Y, W, H : single) : TGPRectF; overload;
function GPRectFMake(const Pt : TGPPointF; const Sz : TGPSizeF) : TGPRectF; overload;
function GPRectFGetLeft(const Rc : TGPRectF) : single;
function GPRectFGetTop(const Rc : TGPRectF) : single;
function GPRectFGetRight(const Rc : TGPRectF) : single;
function GPRectFGetBottom(const Rc : TGPRectF) : single;
function GPRectFEmptyArea(const Rc : TGPRectF) : boolean;
function GPRectFEqual(const RcA, RcB : TGPRectF) : boolean;
function GPRectFContains(const RcOwner : TGPRectF; const X, Y : single) : boolean; overload;
function GPRectFContains(const RcOwner : TGPRectF; const Rc : TGPRectF) : boolean; overload;
function GPRectFInflate(const Rc : TGPRectF; const dX, dY : single) : TGPRectF;
function GPRectFIntersect(const RcA, RcB : TGPRectF) : TGPRectF;
function GPRectFIntersectWith(const RcA, RcB : TGPRectF) : boolean;
function GPRectFUnion(const RcA, RcB : TGPRectF) : TGPRectF;
function GPRectFOffset(const Rc : TGPRectF; const dX, dY : single) : TGPRectF;

{<not GDI+ standard>}
function GPRectFGetMiddlePointF(const Rc : TGPRectF) : TGPPointF;
...
type
  ...
  TGPRect = record
    case integer of
      ...
      1 : ( Location : TGPPoint; Size  : TGPSize; );
  end;
  pGPRectDynArray = ^TGPRectDynArray;
  TGPRectDynArray = array of TGPRect;

function GPRectMake(const X, Y, W, H : integer) : TGPRect; overload;
function GPRectMake(const Pt : TGPPoint; const Sz : TGPSize) : TGPRect; overload;
function GPRectGetLeft(const Rc : TGPRect) : integer;
function GPRectGetTop(const Rc : TGPRect) : integer;
function GPRectGetRight(const Rc : TGPRect) : integer;
function GPRectGetBottom(const Rc : TGPRect) : integer;
function GPRectEmptyArea(const Rc : TGPRect) : boolean;
function GPRectEqual(const RcA, RcB : TGPRect) : boolean;
function GPRectContains(const RcOwner : TGPRect; const X, Y : integer) : boolean; overload;
function GPRectContains(const RcOwner : TGPRect; const Rc : TGPRect) : boolean; overload;
function GPRectInflate(const Rc : TGPRect; const dX, dY : integer) : TGPRect;
function GPRectIntersect(const RcA, RcB : TGPRect) : TGPRect;
function GPRectIntersectWith(const RcA, RcB : TGPRect) : boolean;
function GPRectUnion(const RcA, RcB : TGPRect) : TGPRect;
function GPRectOffset(const Rc : TGPRect; const dX, dY : integer) : TGPRect;

{<not GDI+ standard>}
function GPRectGetMiddlePoint(const Rc : TGPRect) : TGPPoint;
...
function CharacterRange(const First, Length: Integer) : TCharacterRange;
...
const
  ...
  RED_MASK       = ARGB($FF shl RED_SHIFT);
  {$EXTERNALSYM RED_MASK}
  GREEN_MASK     = ARGB($FF shl GREEN_SHIFT);
  {$EXTERNALSYM GREEN_MASK}
  BLUE_MASK      = ARGB($FF shl BLUE_SHIFT);
  {$EXTERNALSYM BLUE_MASK}

  { Color masks not <not GDI+ !> }
  ALPHA_MASK_NOT = ARGB(not ALPHA_MASK);
  {$EXTERNALSYM ALPHA_MASK_NOT}
  RED_MASK_NOT   = ARGB(not RED_MASK);
  {$EXTERNALSYM RED_MASK_NOT}
  GREEN_MASK_NOT = ARGB(not GREEN_MASK);
  {$EXTERNALSYM GREEN_MASK_NOT}
  BLUE_MASK_NOT  = ARGB(not BLUE_MASK);
  {$EXTERNALSYM BLUE_MASK_NOT}
...
function ARGBGetAlpha(const Cl : ARGB) : byte;
function ARGBGetRed(const Cl : ARGB) : byte;
function ARGBGetGreen(const Cl : ARGB) : byte;
function ARGBGetBlue(const Cl : ARGB) : byte;
procedure ARGBGetAll(const Cl : ARGB; var R,G,B : byte); overload;
procedure ARGBGetAll(const Cl : ARGB; var A,R,G,B : byte); overload;

{ <not GDI+ standard !> }
function ARGBSetAlpha(const Cl : ARGB; const A : byte) : ARGB;
function ARGBSetRed(const Cl : ARGB; const R : byte) : ARGB;
function ARGBSetGreen(const Cl : ARGB; const G : byte) : ARGB;
function ARGBSetBlue(const Cl : ARGB; const B : byte) : ARGB;

{ for windows ColorRef }
function ARGBFromColorRef(const Cl : COLORREF) : ARGB;
function ARGBToColorRef(const Cl : ARGB) : COLORREF;

{ for Delphi TColor <not GDI+ standard!>}
function ARGBFromColor(const Cl : integer) : ARGB;
function ARGBToColor(const Cl : ARGB) : integer;

{ Windows Colors to GDI+ Colors }
const
  {$J+}
  { Windows Colors are initialized in the Initialization part }
  aclScrollBar            : ARGB = $FF000000;
  aclBackground           : ARGB = $FF000000;
  aclActiveCaption        : ARGB = $FF000000;
  aclInactiveCaption      : ARGB = $FF000000;
  aclMenu                 : ARGB = $FF000000;
  aclWindow               : ARGB = $FF000000;
  aclWindowFrame          : ARGB = $FF000000;
  aclMenuText             : ARGB = $FF000000;
  aclWindowText           : ARGB = $FF000000;
  aclCaptionText          : ARGB = $FF000000;
  aclActiveBorder         : ARGB = $FF000000;
  aclInactiveBorder       : ARGB = $FF000000;
  aclAppWorkSpace         : ARGB = $FF000000;
  aclHighlight            : ARGB = $FF000000;
  aclHighlightText        : ARGB = $FF000000;
  aclBtnFace              : ARGB = $FF000000;
  aclBtnShadow            : ARGB = $FF000000;
  aclGrayText             : ARGB = $FF000000;
  aclBtnText              : ARGB = $FF000000;
  aclInactiveCaptionText  : ARGB = $FF000000;
  aclBtnHighlight         : ARGB = $FF000000;
  acl3DDkShadow           : ARGB = $FF000000;
  acl3DLight              : ARGB = $FF000000;
  aclInfoText             : ARGB = $FF000000;
  aclInfoBk               : ARGB = $FF000000;
  {$J-}


  { GDI+ Colors definition }
...
{ <not GDI+ standard !> }
{ convert windows ColorRef to GDI+ ARGB }
function ConvertWindowsColorRef(const Color : integer) : ARGB;
...
function ObjectTypeIsValid(type_: ObjectType): BOOL;
begin
  result := (type_ >= ObjectTypeMin) and
            (type_ <= ObjectTypeMax) and
            (type_ <> ObjectTypeInvalid);
end;
...
function GPSizeFGetMiddle(const Sz : TGPSizeF) : TGPSizeF;
begin
  Result.Width := Sz.Width / 2;
  Result.Height:= Sz.Height / 2;
end;
...
function GPSizeGetMiddle(const Sz : TGPSize) : TGPSize;
begin
  Result.Width := Sz.Width shr 1;
  Result.Height:= Sz.Height shr 1;
end;
...
function GpRectFMake(const X, Y, W, H : single) : TGpRectF;
begin
  result.X := X;
  result.Y := Y;
  result.Width  := W;
...
function GpRectFMake(const Pt : TGpPointF; const Sz : TGpSizeF) : TGpRectF;
begin
  result.X := Pt.X;
  result.Y := Pt.Y;
...
function GpRectFEqual(const RcA, RcB : TGpRectF) : boolean;
begin
  result := (RcA.X = RcB.X) and (RcA.Y = RcB.Y) and
            (RcA.Width = RcB.Width) and (RcA.Height = RcB.Height);
end;

function GpRectFContains(const RcOwner : TGpRectF; const X, Y : single) : boolean;
begin
  result := (X >= RcOwner.X) and (X < (RcOwner.X+RcOwner.Width)) and
            (Y >= RcOwner.Y) and (Y < (RcOwner.Y+RcOwner.Height));
end;

function GpRectFContains(const RcOwner : TGpRectF; const Rc : TGpRectF) : boolean;
begin
  result := (RcOwner.X <= Rc.X) and ((Rc.X+Rc.Width) <= (RcOwner.X+RcOwner.Width)) and
            (RcOwner.Y <= Rc.Y) and ((Rc.Y+Rc.Height) <= (RcOwner.Y+RcOwner.Width));
end;
...
begin
  ...
  if aR < bR then
    result.Width := aR - Result.X
  else
    result.Width := bR - Result.X;

  if aB < bB then
    result.Height := aB - Result.Y
  else
    result.Height := bB - Result.Y;

  if GpRectFEmptyArea(Result) then
    Result := GpRectFMake(0,0,0,0);
end;

function GpRectFIntersectWith(const RcA, RcB : TGpRectF) : boolean;
begin
  result := (RcA.X < (RcB.X+RcB.Width)) and
            (RcA.Y < (RcB.Y+RcB.Height)) and
            ((RcA.X+RcA.Width) > RcB.X) and
            ((RcA.Y+RcA.Height) > RcB.Y);
end;
...
function GPRectFGetMiddlePointF(const Rc : TGPRectF) : TGPPointF;
begin
  Result.X := Rc.X + (Rc.Width / 2);
  Result.Y := Rc.Y + (Rc.Height / 2);
end;


{ TGpRect functions }

function GpRectMake(const X, Y, W, H : integer) : TGpRect;
begin
  result.X := X;
  result.Y := Y;
  result.Width  := W;
...
function GpRectMake(const Pt : TGpPoint; const Sz : TGpSize) : TGpRect;
begin
  result.X := Pt.X;
  result.Y := Pt.Y;
  result.Width := Sz.Width;
...
function GpRectContains(const RcOwner : TGpRect; const X, Y : integer) : boolean;
begin
  result := (X >= RcOwner.X) and (X < (RcOwner.X+RcOwner.Width)) and
            (Y >= RcOwner.Y) and (Y < (RcOwner.Y+RcOwner.Height));
end;

function GpRectContains(const RcOwner : TGpRect; const Rc : TGpRect) : boolean;
begin
  result := (RcOwner.X <= Rc.X) and ((Rc.X+Rc.Width) <= (RcOwner.X+RcOwner.Width)) and
            (RcOwner.Y <= Rc.Y) and ((Rc.Y+Rc.Height) <= (RcOwner.Y+RcOwner.Width));
end;
...
begin
  result.X := Rc.X - dX;
  result.Y := Rc.Y - dY;
  result.Width := Rc.Width + (dX shl 1);
  result.Height:= Rc.Height + (dY shl 1);
end;

function GpRectIntersect(const RcA, RcB : TGpRect) : TGpRect;
var aR,aB, bR, bB : integer;
begin
  if RcA.X > RcB.X then
    Result.X := RcA.X
  else
  ...
  if GpRectEmptyArea(Result) then
    Result := GpRectMake(0,0,0,0);
end;
...
function GPRectGetMiddlePoint(const Rc : TGPRect) : TGPPoint;
begin
  Result.X := Rc.X + (Rc.Width shr 1);
  Result.Y := Rc.Y + (Rc.Height shr 1);
end;
...
{ TCharacterRange functions <not GDI+ standard!>}
...
function ARGBGetAlpha(const Cl : ARGB) : byte;
begin
  result := Byte(Cl shr ALPHA_SHIFT);
end;

function ARGBGetRed(const Cl : ARGB) : byte;
begin
  result := Byte(Cl shr RED_SHIFT);
end;

function ARGBGetGreen(const Cl : ARGB) : byte;
begin
  result := Byte(Cl shr GREEN_SHIFT);
end;

function ARGBGetBlue(const Cl : ARGB) : byte;
begin
  result := Byte(Cl shr BLUE_SHIFT);
end;

procedure ARGBGetAll(const Cl : ARGB; var R,G,B : byte); overload;
begin
  R := Byte(Cl shr RED_SHIFT);
  G := Byte(Cl shr GREEN_SHIFT);
  B := Byte(Cl shr BLUE_SHIFT);
end;

procedure ARGBGetAll(const Cl : ARGB; var A,R,G,B : byte); overload;
begin
  A := Byte(Cl shr ALPHA_SHIFT);
  R := Byte(Cl shr RED_SHIFT);
  G := Byte(Cl shr GREEN_SHIFT);
  B := Byte(Cl shr BLUE_SHIFT);
end;
...
begin
  result := ARGB(
              ALPHA_MASK or
              (Windows.GetRValue(Cl) shl RED_SHIFT) or
              (Windows.GetGValue(Cl) shl GREEN_SHIFT) or
              (Windows.GetBValue(Cl) shl BLUE_SHIFT)
            );
end;

function ARGBToColorRef(const Cl : ARGB) : COLORREF;
begin
  result := Windows.RGB(Byte(Cl shr RED_SHIFT),
                        Byte(Cl shr BLUE_SHIFT),
                        Byte(Cl shr GREEN_SHIFT));
end;
...
begin
  result := ARGB(
              ALPHA_MASK or
              (byte(Cl) shl RED_SHIFT) or
              (byte(Cl shr 8) shl GREEN_SHIFT) or
              (byte(Cl shr 16) shl BLUE_SHIFT)
            );
end;
...
begin
  result := integer(
              $00000000 or
              (Byte(Cl shr BLUE_SHIFT) shl 16) or
              (Byte(Cl shr GREEN_SHIFT) shl 8) or
               Byte(Cl shr RED_SHIFT)
            );
end;
...
begin
  if Color < 0 then
    C := Windows.GetSysColor(color and $FF)
  else
    C := Color;

  R := Windows.GetRValue(C);
  G := Windows.GetBValue(C);
...
procedure InitWindowsColors;
begin
  aclScrollBar           := ConvertWindowsColorRef(clScrollBar);
  aclBackground          := ConvertWindowsColorRef(clBackground);
  aclActiveCaption       := ConvertWindowsColorRef(clActiveCaption);
  aclInactiveCaption     := ConvertWindowsColorRef(clInactiveCaption);
  aclMenu                := ConvertWindowsColorRef(clMenu);
  aclWindow              := ConvertWindowsColorRef(clWindow);
  aclWindowFrame         := ConvertWindowsColorRef(clWindowFrame);
  aclMenuText            := ConvertWindowsColorRef(clMenuText);
  aclWindowText          := ConvertWindowsColorRef(clWindowText);
  aclCaptionText         := ConvertWindowsColorRef(clCaptionText);
  aclActiveBorder        := ConvertWindowsColorRef(clActiveBorder);
  aclInactiveBorder      := ConvertWindowsColorRef(clInactiveBorder);
  aclAppWorkSpace        := ConvertWindowsColorRef(clAppWorkSpace);
  aclHighlight           := ConvertWindowsColorRef(clHighlight);
  aclHighlightText       := ConvertWindowsColorRef(clHighlightText);
  aclBtnFace             := ConvertWindowsColorRef(clBtnFace);
  aclBtnShadow           := ConvertWindowsColorRef(clBtnShadow);
  aclGrayText            := ConvertWindowsColorRef(clGrayText);
  aclBtnText             := ConvertWindowsColorRef(clBtnText);
  aclInactiveCaptionText := ConvertWindowsColorRef(clInactiveCaptionText);
  aclBtnHighlight        := ConvertWindowsColorRef(clBtnHighlight);
  acl3DDkShadow          := ConvertWindowsColorRef(cl3DDkShadow);
  acl3DLight             := ConvertWindowsColorRef(cl3DLight);
  aclInfoText            := ConvertWindowsColorRef(clInfoText);
  aclInfoBk              := ConvertWindowsColorRef(clInfoBk);
end;
